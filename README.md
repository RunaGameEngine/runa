...
Current latest public tag: [`v0.7.0-alpha.4`](https://github.com/RunaGameEngine/runa/releases/tag/v0.7.0-alpha.4)

```toml
[dependencies]
runa_engine = { git = "https://github.com/RunaGameEngine/runa.git", tag = "v0.7.0-alpha.4" }
```
